...
mm_order_reminders = "⏰ Напоминания о подтверждении заказа"
...
# Настройки напоминаний о подтверждении заказа
or_enabled = "{} Включить напоминания"
or_timeout = "⏱️ Таймаут: {} мин."
or_template = "✏️ Изменить шаблон"
or_repeat_count = "🔄 Повторений: {}"
...
❌ <i>FunPay Sigma</i> еще <b><u>не инициализирован</u></b> и <b><u>никакие его функции не работают</u></b>.\n
🔃 Как только <i>FunPay Sigma</i> инициализируется, данное сообщение изменится.\n
📋 Если <i>FPS</i> долго не инициализируется, проверь логи с помощью команды /logs"""

fps_init = """✅ <b><u>FPS инициализирован!</u></b>\n
...
👨‍💻 <b>Разработчики:</b> @qorexdev, @sidor0912
📢 <b>Канал обновлений:</b> @fpsfork
🔗 <b>Репозиторий:</b> https://github.com/qorexdev/FunPaySigma"""
...
update_lasted = "✅ У тебя стоит последняя версия FPS Fork {}"
...
desc_lang = desc_main
desc_gs = "Здесь ты можешь включать и выключать основные функции <i>FPS</i>."
...
desc_order_reminders = "Здесь ты можешь настроить напоминания о подтверждении заказа."
