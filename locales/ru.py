...
update_lasted = "✅ У тебя стоит последняя версия FPS {}"
...
update_done = "✅ Установил обновление! Перезапусти <i>FPS</i> с помощью команды /restart"
update_done_exe = "✅ Установил обновление! Новый <code>FPS.exe</code> находится в папке <code>update</code>. " \
                  "Выключи <i>FPS</i>, перенеси новый <code>FPS.exe</code> на место старого " \
