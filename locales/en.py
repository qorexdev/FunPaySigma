...
desc_order_reminders = "Here you can configure reminders for order confirmation.\n\n<b>Current template:</b>\n<code>{}</code>"
...
v_edit_order_reminders_template = "Enter the new template for order confirmation reminder.\n\nCurrent: <code>{}</code>"
